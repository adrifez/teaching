...
**Ejemplo completo:** `ejemplos/01-incluir-script/`
...
**Ejemplo completo:** `ejemplos/02-acceso-dom/`
...
**Ejemplo completo:** `ejemplos/03-captura-eventos/`
...
**Ejemplo completo:** `ejemplos/04-crea-eliminar/`
...
**Ejemplo completo:** `ejemplos/05-envio-formulario/`
...
**Ejemplo completo:** `ejemplos/06-cambiar-clases/`
